export default {
    	...
    	<div class="container">
    		<div id="create-product">
    			<div class="row g-3 mb-3">
    				...
    				<div class="col-sm-6">
      					<input v-model="product.name" type="text" class="form-control" id="name" name="name" required>
    				</div>
    			</div>
    			<div class="row g-3 mb-3">
    			...
    			<div class="row p-5">
    				...
    				<div class="col-sm-4 mb-3" style="text-align: center;">
    					<button v-on:click="createProduct" class="btn btn-lg btn-success">Save</button>
    				</div>
    			</div>
    		</div> <!--Form-->
    	</div>
	...
	methods: {
		async createProduct() {
			...
			const response = await fetch(`/api/category/${id}/product`, {
				method: "POST",
				headers: {
